...
$(document).ready(function() {
	...
	$("#manualplaySelect").click(function(){
		window.location.href = "/music/manualplay/"+plName;
	});
});
var shareDetails={};
	...
	FetchData(
			...
			function(res) {
				for (var i = 0; i < res.length; i++) {
					$("#plists")
							.append(
									'<li><div class="media"><a class="media-left" href="/music/autoplay/'
											+ res[i].name
											+ '"> <img alt="No Image" src="'
											+ res[i].image
											+ '"></a><div class="media-body"><a class="glyphicon glyphicon-menu-left" href="/music/autoplay/'
											+ res[i].name
											+ '">'
											+ res[i].name
											+ '</a></div></div></li>')
...
function afterPlaylistRequested(pl) {
	...
	shareDetails.url = "/music/autoplay/"+urlName;
	plName = urlName;
