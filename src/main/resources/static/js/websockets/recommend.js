	...
	FetchData(
			{
				...
				url : "http://radiorolling.com/public/api/playlist/t?type=4"
			},
			function(res) {
				for (var i = 0; i < res.length; i++) {
					$("#plists")
							.append(
									'<li><div class="media"><a class="media-left" href="http://radiorolling.com/recommend/'
											+ res[i].name
											+ '"> <img alt="No Image" src="'
											+ res[i].image
											+ '"></a><div class="media-body"><a class="glyphicon glyphicon-menu-left" href="http://radiorolling.com/recommend/'
											+ res[i].name
											+ '">'
											+ res[i].name
											+ '</a></div></div></li>')
...
function goToVideo(opt) {
	window.location.href = "http://radiorolling.com/recommend/r?id="+opt.id+"&plName="+plName;
}
...
function afterPlaylistRequested(pl) {
	...
	if (vid_id===-1) {
		...
		shareDetails.url = "http://radiorolling.com/recommend/r?id="+current.id+"&plName="+urlName;
		...
		shareDetails.url = "http://radiorolling.com/recommend/r?id="+chosenVid.id+"&plName="+urlName;
