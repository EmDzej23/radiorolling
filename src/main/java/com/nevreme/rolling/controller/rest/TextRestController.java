...
public class TextRestController extends AbstractRestController<Video, VideoDto, Long> {
	...
	@Autowired
	public TextRestController(AbstractService<Video, Long> repo, VideoDto dto) {
		super(repo, dto);
	}
